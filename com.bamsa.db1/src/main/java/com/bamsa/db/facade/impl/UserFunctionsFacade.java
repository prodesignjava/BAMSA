...
public class UserFunctionsFacade implements UserFunctions {
	...
	public List<CandidateInfoBean> getHotlistdetails() {
		...
		return candidateinfoDAOImpl.getHotlistdetails();
	}
	@Override
	public List<CandidateInfoBean> getCandidateDetails()
	{
		...
		return candidateinfoDAOImpl.getCandidateDetails();
	...
	public OpeningInfoBean getOpeningdetails(int rqid) {
		...
		logger.info("exit  from getOpeningdetails");
		return openingInfoDAOImpl.getOpeningdetails(rqid);
	}
	@Override
	public List<OpeningInfoBean> getAllOpeningdetails() {
		...
		return openingInfoDAOImpl.getAllOpeningdetails();
	}
	@Override
	public CandidateInfoBean updateCandidateDetails(CandidateInfoBean candidatedetails) throws DBUpdateException {
		...
		return candidateinfoDAOImpl.updateCandidateDetails(candidatedetails);
	}
	@Override
	public OpeningInfoBean updatedOpeningDetails(OpeningInfoBean openingdetails) throws DBUpdateException {
		...
		return openingInfoDAOImpl.updatedOpeningDetails(openingdetails);
	}
	@Override
	public CandidateInfoBean updateHotlistDetails(CandidateInfoBean hotlistdetails) throws DBUpdateException {
		...
		return candidateinfoDAOImpl.updateHotlistDetails(hotlistdetails);
	}
	@Override
	public List<ContactBean> getSubcontractEmails() {
		logger.info("enter into getSubcontractEmails");
		logger.info("exit from getSubcontractEmails");
		return contactDAOImpl.getSubcontractEmails();
	}
	@Override
