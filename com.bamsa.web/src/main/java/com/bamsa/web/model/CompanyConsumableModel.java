...
@Component
public class CompanyConsumableModel {
	private int ccid;
	...
	public String getConsumableTag() {
		return consumableTag;
	}
	public void setConsumableTag(String consumableTag) {
	...
	public String toString() {
		...
		builder.append("CompanyConsumableModel [ccid=");
		builder.append(ccid);
		builder.append(",consumableTag");
		builder.append(consumableTag);
		builder.append(", consumableName=");
		builder.append(consumableName);
