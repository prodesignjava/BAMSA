									...
									<table id="myTable" class="table table-striped table-bordered ">
										<thead>
											<tr class="st1 ">
												...
												<th class="info st1" >In Date-Time</th>
												<th class="info st1" >In-IpAddress</th>
												<th class="info st1" >Out Date-Time</th>
												<th class="info st1" >Out-IpAddress</th>
												<th class="info st1" >No.Of Hours</th>
											</tr>
										</thead>
										<tbody>	
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div  class="table-responsive">
        ...
        <tr class="st1" style="text-align:center">
        <td class="st1"><%=k%></td>
        <td class="st1"><%=presentee.getName() %></td>
        <td class="st1"><%=presentee.getEmpId() %></td> 
        </tr>
        <%k++;}} %>
